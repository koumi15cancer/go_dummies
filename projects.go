...
func (s *ProjectService) handleCreateProject(w http.ResponseWriter, r *http.Request) {
	...
	// Declare project as a pointer to Project
	var project *Project // Declare project as a value of type Project
	...
	// Pass a pointer to CreateProject and assign the result back
	project, err = s.store.CreateProject(project) // Now project is being passed by reference
	if err != nil {
